...
interface SellerCardProps {
  readonly status: "none" | "pending" | "approved";
  readonly onRequest: () => void;
}

function SellerStatusCard(props: Readonly<SellerCardProps>) {
  const { status, onRequest } = props;
...
function MenuItem(props: Readonly<MenuItemProps>) {
  const { icon, label, badge, onPress } = props;
  const colors = useColors();
  return (
    <TouchableOpacity
      style={{
        ...
        {sellerStatus === "approved" && (
          <>
            <MenuItem
              ...
              badge="NOUVEAU"
              onPress={() => router.push("/seller-stats")}
            />
            <MenuItem
              icon="dollar-sign"
        ...
        {(sellerStatus === "approved"
          ...
          <TouchableOpacity
            ...
            style={[
              ...
              {
                borderBottomColor:
                  effectiveTab === tab ? colors.primary : "transparent",
              },
            ]}
