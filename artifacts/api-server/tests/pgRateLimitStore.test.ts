...
async function clearRateLimits(): Promise<void> {
  await db.delete(rateLimitsTable);
}
...
describe("PgRateLimitStore — unit: increment", () => {
...
describe("PgRateLimitStore — unit: decrement & resetKey", () => {
  beforeEach(clearRateLimits);
...
describe("PgRateLimitStore — persistence across simulated restarts", () => {
  beforeEach(clearRateLimits);
...
describe("PgRateLimitStore — Express integration: 429 at threshold", () => {
  beforeEach(clearRateLimits);
...
describe("PgRateLimitStore — Express integration: counter persistence survives restart", () => {
  beforeEach(clearRateLimits);
